  ...
  <div class="container">
    <div class="card">
      ...
      <div class="footer">
        ...
        <p><a href="https://forgecv.org/">forgecv.org</a></p>
...
export function welcomeEmail({ name, email }) {
  const content = `
    ...
    <a href="https://forgecv.org/dashboard" class="btn">Go to Dashboard</a>
    <p style="font-size:13px;color:#94a3b8;">Need help? Visit our <a href="https://forgecv.org/support">support page</a>.</p>
  `
  return {
...
export function paymentSuccessEmail({ name, plan, billingCycle, amount, currency, paymentMethod, periodEnd }) {
  ...
  const content = `
    ...
    <a href="https://forgecv.org/dashboard/billing" class="btn">View Billing</a>
    <p style="font-size:13px;color:#94a3b8;">Questions? Visit <a href="https://forgecv.org/support">support</a> or reply to this email.</p>
  `
  return {
...
export function lifetimeSlotEmail({ name, slots, amount, currency }) {
  ...
  const content = `
    ...
    <a href="https://forgecv.org/dashboard/portfolios" class="btn">Manage Portfolios</a>
  `
  return {
...
export function renewalReminderEmail({ name, plan, daysLeft, periodEnd, amount, currency }) {
  ...
  const content = `
    ...
    <a href="https://forgecv.org/dashboard/billing" class="btn">Renew Now</a>
    <p style="font-size:13px;color:#94a3b8;">Need help? <a href="https://forgecv.org/support">Contact support</a>.</p>
  `
  return {
...
export function subscriptionExpiredEmail({ name, plan }) {
  const content = `
    ...
    <a href="https://forgecv.org/pricing" class="btn">View Plans & Renew</a>
  `
  return {
...
export function aiQuotaResetEmail({ name, plan, quota }) {
  const content = `
    ...
    <a href="https://forgecv.org/dashboard" class="btn">Start Creating</a>
  `
  return {
