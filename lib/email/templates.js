...
export function welcomeEmail({ name, email }) {
  const content = `
    ...
    <div class="highlight">
      <p>Free plan includes: 1 resume, 1 portfolio, 1 cover letter, and 5 AI generations per month.</p>
    </div>
...
export function subscriptionExpiredEmail({ name, plan }) {
  const content = `
    ...
    <div class="highlight">
      <p>Free plan: 1 resume, 1 portfolio, 1 cover letter, 5 AI generations/month. Your existing work is safe.</p>
    </div>
