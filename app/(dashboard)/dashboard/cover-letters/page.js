    ...
    <div className="px-4 sm:px-6 lg:px-8 py-6 sm:py-8 max-w-7xl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-foreground/60 text-sm">Manage and edit your cover letters</p>
        </div>
        <button
      ...
      {coverLetters.length === 0 ? (
        <div className="bg-card border border-dashed border-border rounded-2xl p-12 text-center">
          ...
          <p className="text-sm text-foreground/60 mb-6 max-w-sm mx-auto">
            Create your first cover letter to stand out in your job applications
          </p>
          <button
            onClick={createCoverLetter}
          ...
          {coverLetters.map((cl) => (
            ...
            >
              ...
              <Link href={`/dashboard/cover-letters/${cl.id}`} className="block">
                ...
                <h3 className="font-semibold mb-1 pr-20 sm:pr-16 truncate">{cl.title}</h3>
      ...
      {showLimitModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-card border border-border rounded-2xl p-8 max-w-md w-full shadow-elevated">
            ...
            <h3 className="text-xl font-bold tracking-tight mb-2">Cover letter limit reached</h3>
      ...
      {renameTarget && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 px-4">
          <div className="bg-card border border-border rounded-2xl p-8 max-w-md w-full shadow-elevated">
            <h3 className="text-xl font-bold tracking-tight mb-2">Rename Cover Letter</h3>
