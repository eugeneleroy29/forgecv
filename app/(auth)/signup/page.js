    ...
    <main className="min-h-screen bg-background text-foreground flex items-center justify-center px-6">
      ...
      <div className="w-full max-w-md">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 border border-border rounded-lg px-4 py-3 text-sm font-medium hover:border-accent hover:text-accent transition-colors mb-4"
        >
        ...
        <div className="flex flex-col gap-4">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-accent text-white py-3 rounded-lg text-sm font-medium hover:bg-accent-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
